(function () {
  const translations = {
    en: {
      ...
      'auth.forgotPasswordSubtitle': 'Enter your email address and we\'ll help you reset your password.',
      'auth.resetPassword': 'Reset Password',
      'auth.backToLogin': 'Back to Login',
      'auth.emailRequired': 'Email is required',
      'auth.emailNotFound': 'No account found with this email address.',
      'auth.emailFound': 'Account found!',
      ...
      'home.blankTitle': 'New Presentation',
    ...
    ar: {
      ...
      'auth.forgotPasswordSubtitle': 'أدخل عنوان بريدك الإلكتروني وسنساعدك في إعادة تعيين كلمة المرور.',
      'auth.resetPassword': 'إعادة تعيين كلمة المرور',
      'auth.backToLogin': 'العودة إلى تسجيل الدخول',
      'auth.emailRequired': 'البريد الإلكتروني مطلوب',
      'auth.emailNotFound': 'لم يتم العثور على حساب بهذا البريد الإلكتروني.',
      'auth.emailFound': 'تم العثور على الحساب!',
      'auth.enterNewPassword': 'يرجى إدخال كلمة المرور الجديدة أدناه.',
      'auth.newPassword': 'كلمة المرور الجديدة',
      'auth.newPasswordPlaceholder': 'أدخل كلمة المرور الجديدة',
      'auth.confirmPassword': 'تأكيد كلمة المرور',
      'auth.confirmPasswordPlaceholder': 'أعد إدخال كلمة المرور الجديدة',
      ...
      'auth.redirectingToLogin': 'إعادة التوجيه إلى تسجيل الدخول...',
